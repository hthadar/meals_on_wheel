...
<body data-spy="scroll" data-target="#navbar" class="static-layout">
  ...
  <div class="card">
        ...
        <h1>Thank You for Choosing MerryMeal Delivery Services</h1>
        
       <p>Dear John,

We hope this message finds you well.

On behalf of the entire MerryMeal team, we would like to extend our heartfelt gratitude for choosing our delivery services. Your trust and support mean the world to us, and we are honored to have had the opportunity to serve you.

We understand the importance of timely and reliable deliveries, and we strive to exceed your expectations with each and every order. Your satisfaction is our top priority, and we are committed to continuously improving our services to better meet your needs.

We sincerely hope that the meals we've delivered have brought you comfort, nourishment, and joy. Your feedback is invaluable to us, so please don't hesitate to reach out with any comments, suggestions, or concerns you may have.

Once again, thank you, John, for choosing MerryMeal. We look forward to serving you again in the future.

Warm regards,

John Doe
Customer Relations Manager
MerryMeal Delivery Services</p>
        <p><a href="/home">Click here</a> to go to the home page.</p>
    </div>
