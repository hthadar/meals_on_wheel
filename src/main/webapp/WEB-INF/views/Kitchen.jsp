...
.boxed-page {
            background-image: url('img/mmMenu.jpg'); /* Replace 'path/to/your/background-image.jpg' with the actual path to your image */
...
<!-- First Container -->
	<div class="container-fluid bg-1 text-center">
		...
		<div class="container">
    <div class="card">
    <h2 class="margin">Menu Update</h2>
        <div class="card-body">
           
            
            <form:form method="POST" action="/Kit_chen" modelAttribute="Kit_chens"
                    enctype="multipart/form-data">

                    <input type="hidden" value="${_csrf.token}" />
                    <form:hidden path="id" />

                    <c:if test="${Kitchen.id>0}">
                        <div class="form-group">
                            <img src="/images/${Kitchen.Meal_photo}" width="300px">
                            <form:hidden path="Meal_photo" />
                        </div>
                    </c:if>

                    <div class="form-group">
                        <label for="Meal_photo">Upload Meal Photo:</label> 
                        <input type="file" name="file" />
                    </div>


                    <div class="form-group">
                        <form:label path="meal_name">Add Meal Name:</form:label>
                        <form:input path="meal_name" />
                    </div>
                    ...
                    <div class="form-group">
                        <label for="price">Add Meal Price:</label>
