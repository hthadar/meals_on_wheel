    ...
    <div class="container">
  		<div class="col-lg-7" style="margin-left: -15%;">
                <div class="section-content bg-white p-5 shadow">
					...
					<form:form action="/Riders" method="POST"  modelAttribute="Rider" class="delivery-form">
							    <div class="form-row">
							    ...
							    <div class="form-row">
							        ...
							        <div class="form-group">
							            ...
							            <select id="preferred_delivery_time" name="preferred_delivery_time" required>
							                <option value="breakfast">Breakfast (8:00 AM - 10:00 AM)</option>
							                <option value="lunch">Lunch (11:00 AM - 1:00 PM)</option>
							                <option value="dinner">Dinner (5:00 PM - 7:00 PM)</option>
							    ...
							    <div class="form-row">
							        <div class="form-group">
							            <label for="delivery-days">Days of Delivery:</label>
