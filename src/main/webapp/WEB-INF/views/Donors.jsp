...
.navbar-nav {
   ...
   .boxed-page {
    background-image: url('img/donation.jpg'); /* Replace 'path/to/your/background-image.jpg' with the actual path to your image */
                ...
                <div class="section-content bg-white p-5 shadow">
                   ...
                   <form:form method="POST" action="/Donors" modelAttribute="Donor">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="number" class="form-control" id="amount" name="amount" placeholder="Donation Amount" required>
                            </div>
                            <div class="col-md-12 form-group">
                                <textarea class="form-control" id="message" name="message" rows="6" placeholder="Your Message (optional)"required></textarea>
                            </div>
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Donate Now</button>
                            </div>
                        </div>
                    	</form:form>
                </div>
