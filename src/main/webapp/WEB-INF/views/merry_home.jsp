  ...
  <div class="container">
	<div class="row d-flex align-items-center">
		<div class="col-lg-6 hero-left">
		    ...
		    <div class="mb-2">
		    	<a class="btn btn-primary btn-shadow btn-lg" href="/new" role="button">Support Us</a>
            ...
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center py-5">
                    ...
                    <div class="dishes-text">
                        ...
                        <h3 class="special-dishes-price"> Take our service!</h3>
                        <a href="/new" class="btn-primary mt-3">Register</a>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                    ...
                    <div class="dishes-text">
                        ...
                        <h3 class="special-dishes-price"> Take our service!</h3>
                        <a href="/new" class="btn-primary mt-3">Register<span><i class="fa fa-long-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<section id="gtco-menu" class="section-padding">
    ...
    <h6>Breakfast</h6>
        ...
        <div class="menu-details">
         ...
         <div class="mb-2">
		    	<a class="btn btn-primary btn-shadow btn-lg" href="new" role="button">Order</a>
    ...
    <h6>Dinner</h6>
        ...
        <div class="menu-details">
         ...
         <div class="mb-2">
		    	<a class="btn btn-primary btn-shadow btn-lg" href="#" role="button">Order</a>
